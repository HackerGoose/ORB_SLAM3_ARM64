...
BEGIN {
    ...
    require '/home/arkr/ORB_SLAM3_ARM64/Thirdparty/openssl-3.4.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/arkr/ORB_SLAM3_ARM64/Thirdparty/openssl-3.4.0/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/home/arkr/ORB_SLAM3_ARM64/Thirdparty/openssl-3.4.0/test/default-and-jitter.cnf';
    shift;
